...
namespace submissionCHALLANGE_6
{
    public partial class Designation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ddldpt.DataSource =objbal.selectdrop();
